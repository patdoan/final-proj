...
}; //super long but makes sure the 2d array is properly initialized for q4
  

/*// Use this to print all the contents of the 2D array
for (int i = 0; i < 4; i++) {
    for (int j = 0; j < 7; j++) {
        int year = j + 2015; 
        printf("%d avg for province %d: %.2lf\n", year, i, provYearly[i][j]);
    } 
} */
